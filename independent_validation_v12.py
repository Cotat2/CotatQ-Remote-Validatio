...
outdir = HERE / f"results_v12_{args.suite}_{args.mode}"
outdir.mkdir(exist_ok=True)

print()
print("=" * 150)
print("COTATQ v1.2 — INDEPENDENT VALIDATION KIT")
print(
...
raw_path = outdir / f"raw_v12_{args.suite}_{args.mode}_{stamp}.json"
case_csv = outdir / f"cases_v12_{args.suite}_{args.mode}_{stamp}.csv"
rows_csv = outdir / f"rows_v12_{args.suite}_{args.mode}_{stamp}.csv"
report_path = outdir / f"REPORT_v12_{args.suite}_{args.mode}_{stamp}.md"
env_path = outdir / f"environment_v12_{stamp}.json"
...
report = [
    "# CotatQ v1.2 — Independent Validation Report",
    "",
    f"**Verdict: {verdict}**",
    "",
    "## Scope",
