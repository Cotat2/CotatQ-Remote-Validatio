...
def anonymous_environment():
    ...
    return {
        ...
        "compatibility_patch": "v1.2.1-adapter-only",
...
outdir = HERE / f"results_v121_{args.suite}_{args.mode}"
outdir.mkdir(exist_ok=True)

print()
print("=" * 150)
print("COTATQ v1.2.1 — COMPATIBILITY-FIXED VALIDATION")
print(
...
raw_path = outdir / f"raw_v121_{args.suite}_{args.mode}_{stamp}.json"
case_csv = outdir / f"cases_v121_{args.suite}_{args.mode}_{stamp}.csv"
rows_csv = outdir / f"rows_v121_{args.suite}_{args.mode}_{stamp}.csv"
report_path = outdir / f"REPORT_v121_{args.suite}_{args.mode}_{stamp}.md"
env_path = outdir / f"environment_v121_{stamp}.json"
...
report = [
    "# CotatQ v1.2.1 — Compatibility-Fixed Validation Report",
    "",
    f"**Verdict: {verdict}**",
    "",
    "## Scope",
